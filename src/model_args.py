...
class ModelArguments:
    ...
    episode_len_90p: float = field(default=330., metadata={"help": "90th percentile episode length"})
    episode_len_75p: float = field(default=286., metadata={"help": "75th percentile episode length"})
